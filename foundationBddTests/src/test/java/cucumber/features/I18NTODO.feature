Feature: Settings Modification
  ...
  Background:
    ...
    #need dedicated user for that in case of failure
  ...
  Scenario Outline: Test i18n all modules
    ...
    #And I see expected texts from analytics module #error button not clickable
    #And I go to alarm
    #And I see expected texts from alarm module #error acknowledgement
    ...
    #And I see expected texts from setting module #error setting not clickable
