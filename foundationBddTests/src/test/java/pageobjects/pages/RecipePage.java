...
public class RecipePage {
    ...
    private final ElementsCollection recipeNotificationTexts = $$(By.xpath("//div[@class='notification-bar information-bar']"));
    ...
    private final SelenideElement recipeCreateButton = $(By.xpath("//div[(text()='Start creating your recipe by adding actions or phases from the right or pressing') ]/span[(text()='alt')]"));
    ...
    public void selectStep(String stepNo) {
        if (stepNo.contains(",")) {
            ...
            stepAction.keyDown(Keys.CONTROL).perform();
            for (String s : number) {
    ...
    public void errorMessage(String Message) {
        $(By.xpath(String.format(popUpMessage, "Message"))).waitUntil(Condition.visible, 50001);
        commonWaiter(okButton, visible).click();
    }
}
