...
public class RecipeConsolePage {
    ...
    private final SelenideElement recipeStepCount =
            $(By.xpath("//p[text()='STEPS']/parent::div/following-sibling::div//p"));
    ...
    private final SelenideElement manualStartButton =
            $(By.xpath("//img[contains(@src,'/useradminportal/static/media/START_btn.39b80dd0.svg')]"));
    ...
    public void clickOnAbortButton(String afterComments) {
        ...
        commonWaiter(preRunCommentsText, visible).sendKeys(afterComments);
    }
    ...
    public String manualRunStart(String productId, String batchId, String beforeComments) throws InterruptedException {
        ...
        if (manualWindowPopup.waitUntil(Condition.not(visible), 5000, 1000)
                .isDisplayed()) {
            manualWindowPopup.getText()
    ...
    public void start_button() {
        ...
        if (manualWindowPopup.exists()) {
            Assert.assertEquals("warning pop displayed: ", "Recipe is already loaded",
                    manualWindowPopup.waitUntil(visible, 2000)
                            .getText());
            manualWindowPopup_Btn.click();
        }
    ...
    public void iCheckLengthyCharacter() {
        ...
        manualOperationName.sendKeys(this.recipe.getMachineName());
        manualOperationName.sendKeys(Keys.TAB);
    }
