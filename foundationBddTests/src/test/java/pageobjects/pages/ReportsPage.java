...
public class ReportsPage {
    ...
    public void verifyAuditLogsForScheduleBackUp(String backUpName, String loggedInUserName, String scheduledUser,
            String occurrence) {
        $(By.xpath(String.format(userAuditLogs, loggedInUserName, " deactivated backup schedule named ", backUpName)))
                .shouldBe(visible);
    ...
    public void createReportPermission() {
        ...
        reportGenerateButton.waitUntil(visible, 5000, 1000)
                .click();
    }
    ...
    public void viewReportPermission() {
        ...
        templateTab.shouldNot(visible);
        viewSingleReport.waitUntil(visible, 10000L, 1000L)
                .click();
        reportViewButton.click();
    }

    public void viewReportTemplatePermission() {
        openButton.waitUntil(visible, 10000L, 5000L)
                .shouldNot(selected);
        runTab.shouldNot(visible);
        reportTab.shouldNot(visible);
        openReportTemplate("testReportTemplate");
        templateNameTextBox.shouldBe(visible);
        templateNameTextBox.shouldNotBe(enabled);
        reportTemplateStatusIcon.shouldNotBe(visible);
        signatureText.waitUntil(visible, 5000);
        signatureValue.shouldBe(visible);
        templateCancelButton.shouldBe(visible);
