...
GO
INSERT [dbo].[report_repository] ([report_id], [report_name], [created_by], [cause], [state], [status], [file_name], [template_id], [generation_executed_time], [template_version], [generation_triggered_time], [report_type], [esign_status], [signed_by], [signed_on], [esign_code], [drweb_url], [hetp_report_id]) VALUES (1, N'AuditTrail_1', N'Bio4CAdmin', N'manual', N'COMPLETED', N'SUCCESS', N'AuditTrail_1.pdf', NULL, GETUTCDATE(), N'', GETUTCDATE(), N'AuditTrail', N'Not Signed', NULL, NULL, NULL, N'http://localhost:4430/DRWeb/WebAPI/GenReport.aspx?report=Foundn_AuditTrail&format=pdf&reportTitle=%22Audit+Trail%22&StartDate=%222022-02-17+00%3A00%3A00%22&EndDate=%222022-02-17+23%3A59%3A59%22&userId=%22Bio4CAdmin%22&reportType=%22AuditTrail%22&fileName=%22AuditTrail_16%22&reportId=16&auditTrailUser=%22All%22&genTime=%2217%2FFeb%2F2022+04%3A27%3A41%22&timeZone=%22Central+Standard+Time%22&genTime=%2217%2FFeb%2F2022+10%3A27%3A41%22', NULL)
GO
